...
//				System.out.println("Record Inserted...");
	...
	/*
	 * public void upload() throws IOException { byte[] data =
	 * IOUtils.toByteArray(photoFile.getInputStream());
	 * 
	 * Photo photo = new Photo(); photo.setData(data);
	 * 
	 * em.persist(photo); }
	 */
	@Override
	public String addDoctor(Doctor doctor, Role role) throws IOException {
		try {
			Part photo=doctor.getPhotoFile();
			System.out.println("good morning");
			byte[] data = IOUtils.toByteArray(photo.getInputStream());
			SessionFactory sf = SessionHelper.getConnection();
